...
//   if (Borrower) {
//     return <Borrower loan={Borrower} onBack={() => setborrower(null)} />;
//   }
...
//                     <Button variant="light" size="sm" className="me-2" onClick={() => setborrower(app)} >View</Button>
//                   </tr>
//                 ))}
//               </tbody>
//             </table>
...
export default BorrowerxDetails;
